...
namespace ahkmunna\CompositeUniqueValidator;

use Illuminate\Support\ServiceProvider;

class CompositeUniqueValidatorServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->loadTranslationsFrom(__DIR__.'lang/vendor/compositeUniqueValidator', 'compositeUniqueValidator');

        $this->publishes([
            __DIR__.'/lang/' => resource_path('lang/vendor/compositeUniqueValidator'),
        ]);

        // Call the compositeUniqueValidator method
        $this->compositeUniqueValidator();
    }
    ...
    public function compositeUniqueValidator()
    {
